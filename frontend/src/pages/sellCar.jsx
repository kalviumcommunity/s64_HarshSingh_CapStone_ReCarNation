...
const SellCarPage = () => {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      // Send to backend
      await axios.post(`${API_BASE_URL}/listings`, formDataToSend, {
        headers: {
  ...
  }, [formData, activeStep, user._id, navigate]);
              ...
              <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        >
                          ...
                          <option value="Chevrolet">Jeep</option>
                ...
                {activeStep === 2 && (
                  <div className="space-y-6 animate-fadeIn">
                    ...
                    <div 
                      className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center transition-colors duration-200 hover:border-brand-orange"
                    ...
                    >
                      ...
                      >
                        <div className="mx-auto flex flex-col items-center">
                          ...
                          <Button 
                            variant="outline" 
                            className="border-blue-900 text-blue-900 hover:bg-blue-950 hover:text-white"
                          >
