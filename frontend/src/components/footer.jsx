...
// Extracted social media icons as separate components for reusability
const FacebookIcon = () => (
...
// Reusable component for footer link section
...
// Extract year as a constant to avoid recalculating on each render
const currentYear = new Date().getFullYear();

// Main Footer component with memoization for performance
const Footer = memo(() => {
  ...
  return (
    <footer className="bg-[#00254F] text-white py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="mt-4 text-sm text-white/80">
              The trusted marketplace for buying and selling used cars.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-4 text-sm text-white/80">
              Contact us at: <a href="mailto:info@recarnation.com" className="underline">info@recarnation.com</a>
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-white/20 text-sm text-white/80">
          <p>© {currentYear} ReCarNation. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
